    ...
    <div class="bg-contact3" style="background-image: url('auth1/images/bg-01.jpg');">
		<div class="container-contact3">
			<div class="wrap-contact3">
			    ...
			    <center><h4 style="color: white">Marketmasta Login page</h4></center>
			    <center><h6 style="color: red"><b>Please, Login below</b></h6></center>
				<form class="contact3-form validate-form"  method="POST" action="{{ route('login') }}">
                     @csrf
