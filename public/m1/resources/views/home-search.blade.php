        ...
        @foreach($product as $products)
          <div>
            <a href="{{url('single_product/'.$products->id) }}">
              <img src="{{url('/public'.$products->product_image)}}" class="img-fluid"  style="width: 150px; height: 130px">
              <h6 class="title"><b>Product</b>: {{$products->product_name}}</a></h6>
              <h6 class="title" style="color: red"><b>Category</b>: {{$products->product_category}}</a></h6>
              <p class="description"><button class="btn btn-primary"><b>N</b>{{$products->product_price}}.00</button></p>
              </a>
          </div>
         @endforeach
</div>
