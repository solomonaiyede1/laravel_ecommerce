...
<div class="container-fluid pt-5">
    ...
    <div class="row px-xl-5 pb-3">
            ...
            <a class="text-decoration-none" href="{{url('single_product/'.$product->id) }}" style="color: black; font-weight: 1500">
                <div class="cat-item d-flex align-items-center mb-4">
                    <div class="card" style="width: 100%;padding-left: 10px; padding-bottom: 5px; padding-top: 5px; border: none">
                        <img class="img-fluid rounded img-thumbnail" src="{{url(str_replace(' ', '%20', $product->product_image))}}" 
                        style="height: auto; width: 80%; filter: contrast(120%)" alt="">
                        <span style="color: black; font-size:10px; font-weight: 900;z-index: 100; color: blue">N{{number_format($product->product_price)}}</span>
                        <p style="color: black; font-size:10px; font-weight: 900;z-index: 100">{{$product->product_name}}</p>
                        </p>
                    </div>
                </div>
            </a>
     ...
     <div style="margin-left: 10%;" class="page-link">{{ $new_arrival->links('pagination::bootstrap-4') }}</div>
</div>
<hr>
