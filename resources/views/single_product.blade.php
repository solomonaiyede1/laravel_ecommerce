...
<!--          <span class="navbar-toggler-icon"><h3 style="color: white"><a href="{{url('/')}}" style="color: white">Breetek Integrated Solutions</a></h3></span>-->
<!--        </button>-->
<!--        <div class="collapse navbar-collapse" id="navbarResponsive">-->
<!--            <ul style="list-style-type:none; color: white; font-size: 25px">-->
<!--                <li><a href="{{url('/')}}" style="color: white">Breetek Integrated Solutions</a></li>-->
<!--            </ul>-->
<!--          <ul class="navbar-nav ml-auto">-->
<!--            <li class="nav-item active">-->
<!--              <a class="nav-link" href="{{url('/login')}}" style="color: white; font-family: sans serif">Sign in-->
<!--              </a>-->
<!--            </li>-->
<!--            <li class="nav-item">-->
...
<br><br>
        ...
        @foreach($single_product as $s)
          ...
          <div class="col-md-4 col-lg-4">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <img src="{{url(str_replace(' ', '%20', $s->product_image))}}"  class="testimonial-img" alt="" style="width: 80%">
              </a>
            </div>
          </div>
          <div class="col-md-4 col-lg-4" style="background-color: white; width:100%">
                    <div class="card-body">
                      ...
                      <p class="card-text">
                          <b style="font-family:sans serif">Category:</b> {{$s->product_category}}<br>
                          <b style="font-family:sans serif">Name of Product:</b> {{$s->product_name}}<br>
                          <b style="font-family:sans serif">Price of Product:</b><span style="font-weight: 900">N{{number_format($s->product_price)}}</span><br>
                          <div class="card">
                            <div class="card-body">
                              <h3 class="text-title" style="font-family:sans serif">Product Description</h3>
                                <p tyle="font-family:sans serif">{!! html_entity_decode($s->product_description) !!}</p>
                                <p tyle="font-family:sans serif"><b style="font-weight: 900">Part no:</b> {{$s->product_part}}</p>
                                <p tyle="font-family:sans serif"><b style="font-weight: 900">Tag No.:</b>{{$s->product_tag}}</p>
                            </div>
        ...
        <h4 class="section-title position-relative mx-xl-5 mb-4"><span class="bg-default pr-3"; style="color:white">You may also like these products</span></h4>
         ...
         <center style="color: black;">{{ $product_cat->links('pagination::bootstrap-4') }}</center>
</div>
