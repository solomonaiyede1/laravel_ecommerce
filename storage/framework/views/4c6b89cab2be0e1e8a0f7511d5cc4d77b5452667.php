...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php
        $product1=ProductModel::where('product_category', 'network and storage')->paginate(100);
    ?>
    <!-- Hero Section End -->
    ...
    <div class="container-fluid pt-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Network and Storage</span></h2>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   ...
   <?php /**PATH /home/ccharle2/public_html/resources/views/network-and-storage.blade.php ENDPATH**/ ?>