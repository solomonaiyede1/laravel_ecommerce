...
<?php $component->withAttributes(['href' => ''.e(route('dashboard')).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('dashboard'))]); ?>
                        <?php echo e(__('Breetek Integrated Solutions')); ?>
                         ...
                         <?php $__env->slot('trigger'); ?> 
                            ...
                            <?php else: ?>
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md bg-white hover:text-gray-700 focus:outline-none transition">
...
<?php /**PATH /home/ccharle2/public_html/resources/views/navigation-menu.blade.php ENDPATH**/ ?>