...
<?php echo $__env->make('partials/header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php
        $product1=ProductModel::where('product_category', 'lifestyle')->paginate(100);
    ?>
    <!-- Hero Section End -->
    ...
    <div class="container-fluid pt-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Lifestyle</span></h2>
...
<?php echo $__env->make('partials/footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   ...
   <?php /**PATH C:\wamp64\www\ecommerce\resources\views/product/lifestyle.blade.php ENDPATH**/ ?>