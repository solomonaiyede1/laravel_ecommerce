...
<body style="background-color: white">
    ...
    <div class="container-fluid" style="background-color: #FA701B; width: 100%; height: 60px; padding-top: 10px">
        <center><h1 class="ml14">
          ...
          <span class="letters" style="font-size: 20px; color: white; font-family: calibri; letter-spacing: 2px"><?php echo e($banner->title); ?></span>
        ...
        <div class="row bg-secondary py-1 px-xl-5" style="background-color: white">
            <div class="col-lg-9 d-none d-lg-block" style="background-color: white">
                <div class="d-inline-flex align-items-center h-100" style="background-color: white">
                    <a href="<?php echo e('/'); ?>" class="text-decoration-none" style="background-color: white">
                        <img src="/images/logo.jpeg" height="50" width="70" />
                    </a>
                    <!--<span style="padding-left: 10px">About us</span><span style="padding-left: 10px">New Arrival</span>-->
                    <!--<h6 class="ml2" style="color: #172035; font-weight: 900; font-family: sans; font-size: 20px">Welcome to Breetek Integrated Solutions: A one-stop shop for all your IT gadgets</h6>-->
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
        ...
        <center style="background-color: white">
            ...
            <!--<div class="navbar navbar-expand-sm" style="background-color: #43F5F9; padding: 10px">-->
            <!--    <a href="<?php echo e(url('/toner-and-ink-catridges')); ?>" class="nav-item nav-link" style="font-size: 14px; font-weight:900; color: black">Toner and ink catridges</a>-->
            <!--    <a href="<?php echo e(url('/printer')); ?>" class="nav-item nav-link" style="font-size: 14px; font-weight:900;color: black">Printer and Scanner</a>-->
            <!--    <a href="<?php echo e(url('/server-option')); ?>" class="nav-item nav-link" style="font-size: 14px; font-weight:900;color: black">Server Option</a>-->
            <!--    <a href="<?php echo e(url('/network-and-storage')); ?>" class="nav-item nav-link" style="font-size: 14px; font-weight:900;color: black">Network and Storage</a>-->
            <!--</div>-->
            ...
            <div class="col-lg-3 d-none d-lg-block" style="background-color: #FA701B">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        <a href="<?php echo e(url('/network-and-storage')); ?>" class="nav-item nav-link">Network and Storage</a>
                        ...
                        <a href="<?php echo e(url('/lifestyle')); ?>" class="nav-item nav-link">Lifestyle</a>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0" style="height: 40x; padding-top: 10px">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse" style="background-color:#FA701B">
                        <div class="navbar-nav mr-auto py-0" style="background-color:#FA701B">
                            <a href="<?php echo e(url('/')); ?>" class="nav-item nav-link" style="font-weight:900">Home</a>
                            <a href="<?php echo e(url('/phone')); ?>" class="nav-item nav-link" style="font-weight:900">Phones</a>
                            <a href="<?php echo e(url('/desktop')); ?>" class="nav-item nav-link" style="font-weight:900">Desktop</a>
                            <!--<a href="<?php echo e(url('/toner-and-ink-catridges')); ?>" class="nav-item nav-link" style="font-size: 14px; font-weight:900">Toner and ink catridges</a>-->
                            <!--<a href="<?php echo e(url('/webcam')); ?>" class="nav-item nav-link" style="font-size: 14px; font-weight:900">Webcam</a>-->
                            <a href="<?php echo e(url('/computer')); ?>" class="nav-item nav-link" style="font-weight:900">Laptop</a>
                            <a href="<?php echo e(url('/server')); ?>" class="nav-item nav-link" style="font-weight:900">Servers</a>
                            <!--<a href="<?php echo e(url('/server-option')); ?>" class="nav-item nav-link" style="font-size: 14px; font-weight:900">Server Option</a>-->
                            <!--<a href="<?php echo e(url('/printer')); ?>" class="nav-item nav-link" style="font-size: 14px; font-weight:900">Printer and Scanner</a>-->
                            <a href="<?php echo e(url('/software')); ?>" class="nav-item nav-link" style="font-weight:900">Software</a>
                            <a href="<?php echo e(url('/accessory')); ?>" class="nav-item nav-link" style="font-weight:900">Accessories</a>
                            <a href="<?php echo e(url('/lifestyle')); ?>" class="nav-item nav-link" style="font-weight:900">Lifestyle</a>
                            <a href="<?php echo e(url('/games-and-console')); ?>" class="nav-item nav-link" style="font-weight:900">Games and Console</a>
...
anime.timeline({loop: true})
  .add({
    ...
    <!-- Navbar End --><?php /**PATH /home/ccharle2/public_html/resources/views/header.blade.php ENDPATH**/ ?>