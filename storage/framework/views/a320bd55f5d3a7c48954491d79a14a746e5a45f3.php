  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog" style="background-color: white">
      ...
      <div class="modal-content" style="background-color: white">
          <center><h4><span style="color: black">Welcome to Sytemgadget</span></h4></center>
    ...
    <!-- Carousel Start -->
    <div class="container-fluid mb-3" style="background-color:rgba(0,0,255, 0.3)">
        <div class="row px-xl-5">
            
            <div class="col-sm-12 col-md-3 col-lg-3 bg-light" style="margin-top: 10px">
                <div style="height: 350px; padding-top: 10px; width: 230px;">
                    ...
                    <ul style="list-style-type: circle; line-height: 30px">
                        <li><a href="<?php echo e(url('/toner-and-ink-catridges')); ?>" style="font-size: 16px; color: black; font-family: sans serif">Toner and ink catridges</a></li>
                        <li><a href="<?php echo e(url('/printer')); ?>" style="font-size: 16px; color: black; font-family: sans serif">Printer and Scanner</a></li>
                        <li><a href="<?php echo e(url('/server-option')); ?>" style="font-size: 16px;color: black; font-family: sans serif">Server Option</a></li>
                        <li><a href="<?php echo e(url('/webcam')); ?>" style="font-size: 16px; color: black; font-family: sans serif">Webcam</a></li>
                        <li><a href="<?php echo e(url('/phone')); ?>" style="font-size: 16px; color: black; font-family: sans serif">Phones</a></li>
                        <li><a href="<?php echo e(url('/desktop')); ?>" style="font-size: 16px;color: black; font-family: sans serif">Desktop</a></li>
                        <li><a href="<?php echo e(url('/computer')); ?>" style="font-size: 16px;color: black; font-family: sans serif">Laptop</a></li>
                        <li><a href="<?php echo e(url('/server')); ?>" style="font-size: 16px; color: black; font-family: sans serif">Servers</a></li>
                        <li><a href="<?php echo e(url('/software')); ?>" style="font-size: 16px; color: black; font-family: sans serif">Software</a></li>
                        <li><a href="<?php echo e(url('/accessory')); ?>" style="font-size: 16px;color: black; font-family: sans serif">Accessories</a></li>
                        <li><a href="<?php echo e(url('/games-and-console')); ?>" style="font-size: 16px;color: black; font-family: sans serif">Games and Console</a></li>
                        <li><a href="<?php echo e(url('/network-and-storage')); ?>" style="font-size: 16px;color: black; font-family: sans serif">Network and Storage</a></li>
                    </ul>
                </div>
                <hr>
                <div class="card" style="padding-bottom: 5px">
                    <div class="card-body" style="border: none; background-color:#FA701B">
                        <h6 class="text-light" style="font-size: 14px">We operate <b>SMARTLY</b></h6>
                        <h6 class="text-light" style="font-size: 14px">We operate <b>24/7</b></h6>
                        <h6 class="text-light" style="font-size: 14px">Your choice is our priority<b>24/7</b></h6>
                    </div>
                </div>
            </div>
            
            <div class="col-lg-6" style="background-color:#FA701B">
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner" style="border: none">
                        <div class="carousel-item position-relative active  card-body" style="height: 430px;">
                             ...
                             <a class="btn btn-danger" style="background-color: red" href="<?php echo e(url('/computer')); ?>">Shop Now</a>
                             </p>
                            ...
                            <!--        <p class="mx-md-5 px-5 animate__animated animate__bounceIn">MacBooks with powerful features here</p>-->
                            <!--        <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" style="background-color: red" href="<?php echo e(url('/computer')); ?>">Shop Now</a>-->
                            <!--    </div>-->
                            <!--</div>-->
                        </div>
                        <div class="carousel-item position-relative  card-body" style="height: 430px;">
                             ...
                             <a class="btn btn-danger" style="background-color: red" href="<?php echo e(url('/phone')); ?>">Shop Now</a>
                             </p>
                            ...
                            <!--        <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" style="background-color: red" href="<?php echo e(url('/printer')); ?>">Shop Now</a>-->
                            <!--    </div>-->
                            <!--</div>-->
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            ...
                            <!--        <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="<?php echo e(url('/phone')); ?>" style="background-color: red">Shop Now</a>-->
                            <!--    </div>-->
                            <!--</div>-->
                        </div>
                    </div>
            ...
            <div class="col-lg-3" style="margin-top: 10px">
                <div style="height: 200px; padding-top: 3px; background-color: #FA701B" class="card-body">
                    <!--<img class="img-fluid" src="images/itel-s17.jpg" height="100" width="100" alt="">-->
                ...
                <hr>
                <div style="height: 200px; padding-top: 3px;background-color: #FA701B" class="card-body" style="margin-top: 10px">
...
<!--slider starts here -->
    ...
    <div class="container-fluid" style="background-color:rgba(0,0,255, 0.3)">
...
<div class="container-fluid pt-5">
            ...
            <a class="text-decoration-none" href="<?php echo e(url('single_product/'.$product->id)); ?>" style="color: black; font-weight: 1500">
                <div class="cat-item d-flex align-items-center mb-4">
                    <div class="card" style="width: 100%;padding-left: 12px; padding-bottom: 5px; padding-top: 5px; border: none">
                        <img class="img-fluid rounded img-thumbnail" src="<?php echo e(url(str_replace(' ', '%20', $product->product_image))); ?>" style="height: 200px; width: 200px; filter: contrast(105%)" alt="">
                        <span style="color: black; font-size:12px; font-weight: 900;z-index: 100; color: black">N<?php echo e(number_format($product->product_price)); ?></span>
    ...
    <div class="container-fluid pt-5 pb-3">
                    ...
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="card" style="width: 300px; height: 350px;padding-left: 10px; padding-bottom: 5px; padding-top: 5px">
                            ...
                            <p style="color: black; font-size:12px; font-weight: 900;z-index: 100;">
                                N<?php echo e(number_format($product->product_price)); ?>
        ...
        <h4 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Desktop</span></h4>
         <div class="row px-xl-5 pb-3">
            <?php $__currentLoopData = $product7; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-3 col-sm-12 pb-1">
                <a class="text-decoration-none" href="<?php echo e(url('single_product/'.$product->id)); ?>">
                    <div class="cat-item d-flex align-items-center mb-4">
        ...
        <h4 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Server Option</span></h4>
         <div class="row px-xl-5 pb-3">
            <?php $__currentLoopData = $product8; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-3 col-sm-12 pb-1">
                <a class="text-decoration-none" href="<?php echo e(url('single_product/'.$product->id)); ?>">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="card" style="width: 300px; height: 350px;padding-left: 10px; padding-bottom: 5px; padding-top: 5px">
        ...
        <h4 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Accessory</span></h4>
         <div class="row px-xl-5 pb-3">
            <?php $__currentLoopData = $product9; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-3 col-sm-12 pb-1">
                <a class="text-decoration-none" href="<?php echo e(url('single_product/'.$product->id)); ?>">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="card" style="width: 300px; height: 350px;padding-left: 10px; padding-bottom: 5px; padding-top: 5px">
        ...
        <h4 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Lifestyle</span></h4>
         <div class="row px-xl-5 pb-3">
            <?php $__currentLoopData = $product10; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-3 col-sm-12 pb-1">
                <a class="text-decoration-none" href="<?php echo e(url('single_product/'.$product->id)); ?>">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="card" style="width: 300px; height: 350px;padding-left: 10px; padding-bottom: 5px; padding-top: 5px">
        ...
        <h4 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Games and Console</span></h4>
         <div class="row px-xl-5 pb-3">
            <?php $__currentLoopData = $product11; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-3 col-sm-12 pb-1">
                <a class="text-decoration-none" href="<?php echo e(url('single_product/'.$product->id)); ?>">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="card" style="width: 300px; height: 350px;padding-left: 10px; padding-bottom: 5px; padding-top: 5px">
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 pb-1">
                <a class="text-decoration-none" href="<?php echo e(url('single_product/'.$product->id)); ?>">
                    <div class="cat-item d-flex align-items-center mb-4">
                       <div class="card" style="width: 300px; height: 350px;padding-left: 10px; padding-bottom: 5px; padding-top: 5px">
                            <img class="img-fluid" src="<?php echo e(url(str_replace(' ', '%20', $product->product_image))); ?>" style="height: 200px; width: 200px; filter: contrast(105%)" alt="">
                            <p style="color: black; font-size:12px; font-weight: 500; z-index: 100"><?php echo e(Str::limit($product->product_name, $limit = 70, $end = '')); ?></p>
    ...
    <!-- <h4 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Web Cam</span></h4>-->
    <!--        <div class="row px-xl-5 pb-3">-->
    <!--        <?php $__currentLoopData = $product6; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
...
<!--<hr style="border: 2px dashed #FA701B">-->
        ...
        <div class="container-fluid pt-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4" style="background-color:rgba(0,0,255, 0.3)"><span class="bg-secondary pr-3" style="background-color:rgba(0,0,255, 0.3)">Recommended for you</span></h2>
        <div class="row px-xl-5 pb-3">
    ...
    <!-- Footer Start -->
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ccharle2/public_html/resources/views/welcome.blade.php ENDPATH**/ ?>