...
<html lang="en">
<head>
  <title>Marketmasta- Mall: Shopping cart</title>
  <meta charset="utf-8">
...
<div class="container" style="width: 70%; margin-left: 10%">
    ...
    <br>
<div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12" style="background-image: url('/img/blog/details/details-hero.jpg'); height: 100px; padding-top: 10px">
        <center><h3 style="color: white">Marketmasta Shopping cart</h3></center>
    </div>
</div><br><br>
<table class="table-hover" style="width: 100%;" border="0px">
<thead class="thead-dark" style="background-color: #90EE90; color: white; height: 50px;">
<tr>
...
?>
<td><center>
    <a href="{{url('/addToCart', $cart['id'])}}" class="btn" style="background-color: red; color: white">Remove</a>
    </center></td>
</tr>
@endforeach
@else
<a class="btn bt-transparent" href="{{url('/')}}" style="border: 1px green solid"><i style="font-size:24px; color: white" class="fa">&#xf07a;</i>Back to Home Page</a><br><br>
@endif
<tr>
<td></td>
<td></td>
...
@if(session()->get('cart')==null)
<br>
<td style="text-align: right"><a href="" class="btn btn-info">cart empty</a></td>
@else
...
<a class="btn btn-success" href="{{url('/order')}}"><i style="font-size:24px; color: white" class="fa">&#xf07a;</i>Proceed to checkout</a>
